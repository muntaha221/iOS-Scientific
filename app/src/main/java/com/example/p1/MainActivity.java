...
//        btnPlus.setOnClickListener(v -> operationClick("+"));
//        btnMinus.setOnClickListener(v -> operationClick("-"));
//        btnMultiply.setOnClickListener(v -> operationClick("×"));
//        btnDivide.setOnClickListener(v -> operationClick("÷"));
//
...
//
//        // Let the activity handle recreation
//        // The onCreate will be called again, and our fields will be reinitialized
//
